...
public class ExtentReport {
	...
	public static void initialize(String path) {
		if (extentreport == null) {
			extentreport = new ExtentReports(path);
			extentreport.addSystemInfo("Host Name", System.getProperty("user.name"));
			extentreport.addSystemInfo("Environment", "UI Testing");
			extentreport.loadConfig(new File(Constants.ProjectBasePath+"/resource/extent-config.xml"));
		}
	}
