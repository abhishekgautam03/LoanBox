...
import Clipan.ClipanCalculateLoan;
...
public class Clipan {
	...
	String financerid = Constants.Clipan;

	
	@Test
	public void testClipan() throws IOException{
		...
		ClipanCalculateLoan loan = new ClipanCalculateLoan();
		loan.getQuote();
